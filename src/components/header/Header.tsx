...
export default function Header() {
  return (
    ...
    <>
    {/* {sidebar} */}
    {/* <div className="hidden sm:flex fixed ">

      <div id="sidebar" className="sidebar fixed left-0 top-0 h-[100%] w-[78px] bg-bgcol1/[.35] backdrop-blur-md z-30 px-1 py-2 transition-all duration-150 ease-in">
        <div className="logo-info flex items-center relative h-[60px]   "  >
          <i className="bx bx1-youtue icon  text-[28px]">
            <svg
          ...
          <h2>GptAi</h2>
          <i className="bx bx-menu" id="menu">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
